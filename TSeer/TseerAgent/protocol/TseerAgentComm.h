...
namespace Tseer
{
    ...
    inline string etos(const LB_GET_TYPE & e)
    {
        switch(e)
        {
    ...
    inline int stoe(const string & s, LB_GET_TYPE & e)
    {
    ...
    inline string etos(const LB_TYPE & e)
    {
        switch(e)
        {
    ...
    inline int stoe(const string & s, LB_TYPE & e)
    {
    ...
    struct AgentRouterRequest : public tars::TarsStructBase
    {
    public:
        ...
        {
            _os.write((tars::Int32)getType, 1);
            _os.write((tars::Int32)lbType, 2);
            if (obj != "")
            {
                _os.write(obj, 3);
            }
        ...
        {
            resetDefautlt();
            tars::Int32 eTemp1 = Tseer::GET_IDC;
            _is.read(eTemp1, 1, false);
            getType = (Tseer::LB_GET_TYPE)eTemp1;
            tars::Int32 eTemp2 = Tseer::LB_TYPE_LOOP;
        ...
        ostream& display(ostream& _os, int _level=0) const
        {
            ...
            _ds.display((tars::Int32)getType,"getType");
            _ds.display((tars::Int32)lbType,"lbType");
            _ds.display(obj,"obj");
        ...
        {
            tars::TarsDisplayer _ds(_os, _level);
            _ds.displaySimple((tars::Int32)getType, true);
            _ds.displaySimple((tars::Int32)lbType, true);
    ...
    struct RouterNodeInfo : public tars::TarsStructBase
    {
    public:
        static string className()
        {
    ...
    struct AgentRouterResponse : public tars::TarsStructBase
    {
    public:
        static string className()
        {
    ...
    public:
        ...
        std::string obj;
        std::string setname;
        vector<Tseer::RouterNodeInfo> resultList;
    };
    ...
    public:
        ...
        void writeTo(tars::TarsOutputStream<WriterT>& _os) const
        {
            ...
            _os.write((tars::Int32)lbType, 11);
            _os.write((tars::Int32)getType, 12);
            if (identifier != "")
            {
        ...
        void readFrom(tars::TarsInputStream<ReaderT>& _is)
        {
            ...
            tars::Int32 eTemp11 = Tseer::LB_TYPE_LOOP;
            _is.read(eTemp11, 11, false);
            lbType = (Tseer::LB_TYPE)eTemp11;
            tars::Int32 eTemp12 = Tseer::GET_IDC;
